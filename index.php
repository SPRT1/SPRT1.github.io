...
<body>
    <header style="background-image: url(&quot;assets/img/backgound.jpg&quot;);width: 100%;height: 100%;padding-bottom: 7rem;">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12" style="text-align: center;">
                <button class="btn btn-primary cat-buton BTN" type="button" data-category-target="Minecraft">Minecraft</button>
                <button class="btn btn-primary cat-buton BTN" type="button" data-category-target="Discord Bot Host">Discord Bot Host</button>
                <button class="btn btn-primary cat-buton BTN" type="button" data-category-target="Discord Bot Gen">Discord Bot Gen</button>
                <button class="btn btn-primary cat-buton BTN" type="button" data-category-target="GTA5">GTA5</button>
                <button class="btn btn-primary cat-buton BTN" type="button" data-category-target="ARK">ARK</button>
                <button class="btn btn-primary cat-buton BTN" type="button" data-category-target="Voice Servers">Voice Servers</button>
                <button class="btn btn-primary cat-buton BTN" type="button" data-category-target="CSGO">CSGO</button>
                <button class="btn btn-primary cat-buton BTN" type="button" data-category-target="Aplicaciones">Aplicaciones</button>
                <button class="btn btn-primary cat-buton BTN" type="button" data-category-target="Juegos Steam">Juegos Steam</button>
                <button class="btn btn-primary cat-buton BTN" type="button" data-category-target="Complementos">Complementos</button>
            ...
            <div class="col-md-4" data-category="<?php echo $r2["Category"] ?>">
                <div class="card product-card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text product-desc"><?php echo $r2["Description"] ?><br></p><button class="btn btn-primary purchas-ebtn" type="button" data-sellix-product="<?php echo $r2["SellixID"] ?>">Comprar</button>
                    </div>
                </div>
            </div>
            <?php endforeach; ?>
